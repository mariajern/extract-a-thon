      ...
      {shouldShowDetailedLayout ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full mt-8">
          ...
          <div className="rounded-md overflow-hidden shadow-xl h-full bg-card">
            <Image
              src="https://cdn.sanity.io/images/30p7so6x/eqt-public-web-prod/1c988d29e40b825a30e57791b27a7f0447463530-1495x1017.webp?rect=200,160,1070,803&w=420&h=315&auto=format"
        ...
        <>
          {!shouldShowDetailedLayout && sector.id !== 'segment-performance' && children}
